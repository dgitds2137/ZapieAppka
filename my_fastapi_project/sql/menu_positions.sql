...
;WITH PositionSeed AS (
    ...
    FROM (VALUES
        ...
        (N'zapiekanki_frozen', 10, N'Pieczarka VAC', 200, 400, CAST(39 AS DECIMAL(18, 0)), N'Zapiekanka do wypieku w domu. Gramatura: 200 g. Sklad: bagietka, maslo 20g, pieczarki 120g, cheddar 80g, mozzarella 40g. Sosy do VAC sa platne.', N'assets/images/zapMushroomFrozen.png', CAST(1 AS BIT)),
        (N'zapiekanki_frozen', 20, N'Salami VAC', 200, 460, CAST(42 AS DECIMAL(18, 0)), N'Zapiekanka do wypieku w domu. Gramatura: 200 g. Sklad: bagietka, maslo 20g, pieczarki 120g, cheddar 80g, mozzarella 40g, salame spianata 30g. Sosy do VAC sa platne.', N'assets/images/zapSalameFrozen.png', CAST(1 AS BIT)),
        (N'zapiekanki_frozen', 30, N'Hawajska VAC', 200, 440, CAST(41 AS DECIMAL(18, 0)), N'Zapiekanka do wypieku w domu. Gramatura: 200 g. Sklad: bagietka, maslo 20g, pieczarki 120g, cheddar 80g, mozzarella 40g, szynka 30g, ananas 40g. Sosy do VAC sa platne.', N'assets/images/zapMeatFrozen.png', CAST(1 AS BIT)),
        (N'zapiekanki_frozen', 40, N'Grecka VAC', 200, 430, CAST(41 AS DECIMAL(18, 0)), N'Zapiekanka do wypieku w domu. Gramatura: 200 g. Sklad: bagietka, maslo 20g, pieczarki 120g, cheddar 80g, mozzarella 40g, oliwki 20g, pomidor 40g. Sosy do VAC sa platne.', N'assets/images/zapCheeseFrozen.png', CAST(1 AS BIT)),
